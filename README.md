...
- **Processamento de Imagem**: Integrar o `Sharp` para compressão automática e conversão para formato `.webp`;
...
- **Padronização de Erros**: Centralizar o tratamento de exceções com o utilitário throwHttpError().
